...
$acs = array('space', 'doing', 'upload', 'comment', 'blog', 'album', 'relatekw', 'common', 'class',
	...
	'click','magic', 'top', 'videophoto','introduce','product','development','industry','text','cases','branch',
	'job','talk','menuset','message','recommend','moblie','goods','book','myweixin','dialog','weixinmenu','dialog','menusetchoice');
