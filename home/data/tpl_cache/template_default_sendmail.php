<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/sendmail', '1379414307', 'template/default/sendmail');?><table cellspacing="0" cellpadding="20">
<tr><td>
