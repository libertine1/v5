<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_job_view|template/default/header|template/default/space_menu|template/default/footer', '1377627111', 'template/default/space_job_view');?><?php $_TPL['titles'] = array($job['subject'], $newname[subject]); ?>
