<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_job_view|template/default/header|template/default/space_menu|template/default/footer', '1378279007', 'template/default/space_job_view');?><?php $_TPL['titles'] = array($job['subject'], $newname[subject]); ?>
