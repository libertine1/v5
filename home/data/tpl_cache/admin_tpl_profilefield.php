<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('admin/tpl/profilefield|admin/tpl/header|admin/tpl/side|admin/tpl/footer|template/default/header|template/default/footer', '1378347560', 'admin/tpl/profilefield');?><?php $_TPL['formtypes'] = array('text'=>'文本输入', 'select'=>'单选列表', 'multi'=>'多选列表'); ?>
