<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_book_list|template/default/header|template/default/footer', '1377053243', 'template/default/space_book_list');?><?php $_TPL['titles'] = array('预约预定'); ?>
 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
    ...
    <script type="text/javascript">
       $(document).ready(function(){
        ...
        $('#basic-modal-content<?=$value['productid']?>').attr("style", "display:none;");
           $('#basic-modal<?=$value['productid']?>').click(function (e) {
    		e.preventDefault();
    	   $('#basic-modal-content<?=$value['productid']?>').modal();
  });
