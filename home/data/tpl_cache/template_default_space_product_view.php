<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_product_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1378365190', 'template/default/space_product_view');?><?php $_TPL['titles'] = array($product['subject'], $newname[subject]); ?>
