<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_goods|template/default/header|template/default/footer', '1379415097', 'template/default/space_goods');?><?php $_TPL['titles'] = array('商品管理'); ?>
                     ...
                     <div class="content_list container_12">
                          ...
                          <div class="grid_2">
                             <div class="mylist">
                                  ...
                                  <table>
                                  	<tr>
                                   <td style="width:236px;"><a href="space.php?uid=<?=$value['uid']?>"> <span>发布:<?=$_SN[$value['uid']]?></span></a><br/></td>
                                    ...
                                    <td style="width:56px;"><?php if($value['replynum']) { ?><a href="space.php?uid=<?=$value['uid']?>&do=<?=$do?>&id=<?=$value['goodsid']?>#comment"><span>评论: (<?=$value['replynum']?> )</span></a><?php } else { ?><span>评论: (0)</span><?php } ?></td>
                                  </tr>
                                  </table>
                             </div>
                             <div class = "mybox">
   ...
   <div class="footer">
      ...
      <div class="contactUs">
        <ul>
          ...
          <a href="#"><li class="listItem">开通流程</li></a>
          <a href="#"><li class="listItem">管理员手册</li></a>
          <a href="#"><li class="listItem">用户手册</li></a>
        </ul>
        ...
        <ul>
          ...
          <a href="#"><li class="listItem">在线客服</li></a>
          <a href="#"><li class="listItem">留言板</li></a>
          <a href="#"><li class="listItem">用户手册</li></a>
        </ul>
        ...
        <ul>
          ...
          <a href="#"><li class="listItem">品牌企业合作</li></a>
          <a href="#"><li class="listItem">媒体合作</li></a>
          <a href="#"><li class="listItem">收费细节</li></a>
        </ul>
        ...
        <ul class="last">
          ...
          <a href="#"><li class="listItem">企业介绍</li></a>
          <a href="#"><li class="listItem">联系方式</li></a>
          <a href="#"><li class="listItem">人才招聘</li></a>
        </ul>
