<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_avatar|template/default/header|template/default/footer', '1378441373', 'template/default/cp_avatar');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
