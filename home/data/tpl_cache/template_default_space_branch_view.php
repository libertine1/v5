<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_branch_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1378278993', 'template/default/space_branch_view');?><?php $_TPL['titles'] = array($branch['subject'], $newname[subject]); ?>
