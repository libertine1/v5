<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_industry|template/default/header|template/default/cp_topic_menu|template/default/footer|template/default/space_topic_inc', '1378447620', 'template/default/cp_industry');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
