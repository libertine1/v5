<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_cases_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1378278840', 'template/default/space_cases_view');?><?php $_TPL['titles'] = array($cases['subject'], $newname[subject]); ?>
