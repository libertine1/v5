<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_goods_view|template/default/header|template/default/space_menu|template/default/space_comment_li|template/default/footer', '1377791617', 'template/default/space_goods_view');?><?php $_TPL['titles'] = array($goods['subject'], '商品管理'); ?>
